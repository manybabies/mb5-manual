...
[^procedure-2]: Familiarization time specifies the duration of the familiarization phase (*fixed-length* design), or the duration of accumulated looking time needed to end the familiarization phase (*infant-controlled* design).
<br>
