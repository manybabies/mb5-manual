...
3.  Familiarization time (*5s*, *10s*, or *15s*)[^procedure-1]

The order of these trials will be counterbalanced along a number of dimensions across participants and labs.

[^procedure-1]: Familiarization time specifies the duration of the familiarization phase (*fixed-length* design), or the duration of accumulated looking time needed to end the familiarization phase (*infant-controlled* design).
<br>
