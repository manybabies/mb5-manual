...
+--------+----------------+------------------+--------------------------+--------------------------------------------------------+
| Event  | Stimulus Class | Complexity Level | Familiarization Time (s) | Example Stimulus                                       |
+========+================+==================+==========================+========================================================+
| 1 <br> |  <br>          |  <br>            | 5   <br>                 | <img src="images/fribbuli-low.png" height="50"></img>  |
| 2 <br> | Fribbuli       |  Low             | 10  <br>                 |                                                        |
| 3      |                |                  | 15                       |                                                        |
+--------+----------------+------------------+--------------------------+--------------------------------------------------------+
| 4 <br> |  <br>          |  <br>            | 5   <br>                 | <img src="images/fribbuli-high.png" height="50"></img> |
| 5 <br> | Fribbuli       |  High            | 10  <br>                 |                                                        |
| 6      |                |                  | 15                       |                                                        |
+--------+----------------+------------------+--------------------------+--------------------------------------------------------+
| 7 <br> |  <br>          |  <br>            | 5   <br>                 | <img src="images/fribbuli-low.png" height="50"></img>  |
| 8 <br> | Fractals       |  Low             | 10  <br>                 |                                                        |
| 9      |                |                  | 15                       |                                                        |
+--------+----------------+------------------+--------------------------+-----------------------------+--------------------------+
| 10 <br>|  <br>          |  <br>            | 5   <br>                 | <img src="images/fribbuli-high.png" height="50"></img> |
| 11 <br>| Fractals       |  High            | 10  <br>                 |                                                        |
| 12     |                |                  | 15                       |                                                        |
+--------+----------------+------------------+--------------------------+--------------------------------------------------------+

: Familarization events *(Note: Order of events will be randomized for each pariticipant)* {#tbl-familiarization2}
