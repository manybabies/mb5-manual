# Setting up the experiment {#setup .unnumbered}
...
-   @sec-participants: [**Participants and recruitment**](#sec-participants)
-   @sec-stimuli: [**Stimuli**](#sec-stimuli)
-   @sec-procedure: [**Procedure**](#sec-procedure)
-   @sec-apparatus: [**Apparatus**](#sec-apparatus)
-   @sec-validation: [**Data validation**](#sec-validation)
