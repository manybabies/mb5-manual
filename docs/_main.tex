...
\addcontentsline{toc}{paragraph}{MB5 Project website}

\paragraph*{ManyBabies General Manual}\label{manybabies-general-manual}
\addcontentsline{toc}{paragraph}{ManyBabies General Manual}

\paragraph*{MB5 Collaboration Agreement}\label{mb5-collaboration-agreement}
\addcontentsline{toc}{paragraph}{MB5 Collaboration Agreement}
...
\addcontentsline{toc}{paragraph}{MB5 Stage 1 Registered Report }
...
\addcontentsline{toc}{paragraph}{MB5 Contact: \href{mailto:mb5@manybabies.org}{\nolinkurl{mb5@manybabies.org}} }
