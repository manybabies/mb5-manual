...
\item ~
  ...
  \addcontentsline{toc}{subsubsection}{MB5 issue tracker form}
\item ~
  ...
  \addcontentsline{toc}{subsubsection}{MB5 documentation upload form }
\item ~
  \subsubsection*{MB5 data upload form}\label{mb5-data-upload-form}
  \addcontentsline{toc}{subsubsection}{MB5 data upload form}
\end{itemize}
