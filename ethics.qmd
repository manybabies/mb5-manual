...
(@) **Specific consent** for this purpose collected from your participants' parents/guardians. 
...
We are aware that many laboratories, particularly those based in regions governed by GDPR, may not be allowed to use Databrary. In these circumstances, we encourage labs to use alternative methods for sharing their videos where possible ({{< var email.emailus >}} to discuss options).
