...
\addcontentsline{toc}{paragraph}{BEFORE you begin data collection:}
...
\addcontentsline{toc}{paragraph}{Data collection:}
...
\addcontentsline{toc}{paragraph}{AFTER you finish data collection:}
...
\addcontentsline{toc}{subsubsection}{IMPORTANT: DO NOT begin data collection (other than piloting) until you have been explicitly (and individually) ``greenlighted'' to do so.}
