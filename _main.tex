...
\tightlist
\item
  \textbf{MB5 Project website:} \url{manybabies.org/MB5}
\item
  \textbf{ManyBabies General Manual:} \href{https://docs.google.com/document/d/1dZ3sF2UcxvpkfOfKSKFeObTMZRbpUYloMUiPYtZy0ng/edit?usp=sharing}{link}
\item
  \textbf{MB5 Collaboration Agreement:} \href{https://docs.google.com/document/d/1vbTDmH6euda5pJN4uyds3zsnQ1DXrW9wpHogwC-5TSk/edit?usp=sharing}{link}
\item
  \textbf{MB5 Stage 1 Registered Report:} \citep{kosiezettersten2024}
\item
  \textbf{MB5 Contact:} \url{mb5@manybabies.org}
\end{itemize}
