...
4.  Can the baby see the experimenter during testing? How does the experimenter see the baby? (e.g.,videofeed)
5.  If live-coding takes place: Show examples of what counts as a look / no look and/or videotape someone doing the coding together with the infant looks.
6.  How is the experimenter blinded to trial type during testing?
7.  Hos is the parent blinded during testing (blacked-out glasses or something similar)?

### Questionnaire(s)

1.  At what point do you hand out/collect questionnaires (e.g., pre- or post-experiment)?
2.  Do you give any additional instructions other than those listed on the form(s)?
