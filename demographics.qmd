...
[^demographics-2]: In other words, please confirm that blank items are intentional non-responses rather than mistakes (e.g., didn't turn the form over, etc.).
...
If you have any questions about adapting the questionnaire, please contact the leadership team ({{< var email.support >}}) to discuss your concerns. Let us know if any of the questions are unclear to you---it is important that you are able to answer any questions the participants may have.
...
[^demographics-3]: Translations/adaptations of the MB-Demographics template are available via the <a href="https://osf.io/nqc92/files/osfstorage" target="_blank">MB-Demographics OSF repository</a>.
